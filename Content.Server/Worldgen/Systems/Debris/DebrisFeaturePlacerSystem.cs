...
using Content.Shared._Triad.CCVar; // Triad: records gate
using Robust.Shared.Configuration; // Triad: records gate
...
public sealed class DebrisFeaturePlacerSystem : BaseWorldSystem
{
    ...
    [Dependency] private readonly IConfigurationManager _cfg = default!; // Triad: records gate
    ...
    {
        // Triad: the worldgen records decide cell contents ahead of time and spawns them through a
        ...
        if (_cfg.GetCVar(TriadCCVars.WorldgenRecordsEnabled))
            return;
