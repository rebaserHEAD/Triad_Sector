...
public sealed partial class DrydockAdminWindow : FancyWindow
{
    ...
    private static Control StatePill(DrydockAdminShipDto ship)
    {
    ...
    private static Control Pill(string text, Color colour)
    {
        var panel = new PanelContainer { PanelOverride = PillBox(colour), VerticalAlignment = VAlignment.Center };
        panel.AddChild(new Label { Text = text, Modulate = colour, Margin = new Thickness(6, 1) });
        return panel;
    }
