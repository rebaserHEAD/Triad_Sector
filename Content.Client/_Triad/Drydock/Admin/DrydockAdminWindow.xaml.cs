...
public sealed partial class DrydockAdminWindow : FancyWindow
{
    ...
    {
        var (callsign, name) = SplitCallsign(fullName);
        return callsign == null
            ? fullName
            : Loc.GetString("drydock-admin-card-title", ("callsign", callsign), ("name", name));
    }

    private static (string? Callsign, string Name) SplitCallsign(string fullName)
    {
    ...
    private static FormattedMessage Occupant(DrydockAdminBerthDto berth, DrydockAdminShipDto selected)
    {
        ...
        msg.AddText(isLastBerth
            ? Loc.GetString("drydock-admin-berth-last", ("ship", SplitCallsign(selected.Name).Name))
