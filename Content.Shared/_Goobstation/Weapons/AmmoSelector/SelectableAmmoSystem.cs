...
// using Content.Shared._Goobstation.Wizard.UserInterface; - mono
...
public sealed partial class SelectableAmmoSystem : EntitySystem
{
    ...
    {
        // if (!_activatableUiWhitelist.CheckWhitelist(ent, args.Actor)) mono
        //     return;
    ...
    private string? GetProviderProtoName(EntityUid uid)
    {
        ...
        // if (TryComp(uid, out ChangelingChemicalsAmmoProviderComponent? chemicals)) mono
