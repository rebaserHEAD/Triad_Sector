...
drydock-admin-release = Lift impound
drydock-admin-impound-tooltip = Take the ship into the holding area pending a decision. Retrieve is refused while it is there. Lifting returns it to where the impound found it.
drydock-admin-restore-to = Restore to…
drydock-admin-restore-to-tooltip = Put a ship that is out, impounded or gone back into one of the owner's berths. Refused while a live grid still carries it this round.
drydock-admin-more = ···
...
drydock-admin-action-ImpoundReleased = Impound lifted
...
drydock-admin-action-ImpoundRedeemed = Impound redeemed
...
drydock-admin-action-ShipStranded = Stranded by a failed sweep
drydock-admin-action-ClaimReleased = Claim released after a failed retrieve
