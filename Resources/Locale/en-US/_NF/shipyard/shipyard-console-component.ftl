...
shipyard-console-berths-label = Berths
shipyard-console-ships-label = Ships
shipyard-console-berth-buy-button = Buy berth
shipyard-console-berth-sell-button = Sell
shipyard-console-berth-upgrade-button = Upgrade to {$class} (+{$price})
shipyard-console-berth-empty = empty
shipyard-console-berth-holds = holds {$ship}
shipyard-console-berth-summary = {$free} of {$total} berths free · {$out} ship(s) out
...
shipyard-console-ship-state-stored = stored
shipyard-console-ship-state-out = out
shipyard-console-ship-state-held = held by administration
shipyard-console-transfer-button = Transfer
shipyard-console-transfer-accept-button = Accept transfer
...
shipyard-console-transfer-offer = {$owner} is offering {$ship} ({$class}). {$seconds}s left.
shipyard-console-transfer-warning = Accepting takes your last free berth while you have a ship out. It will have nowhere to dock at round end.
