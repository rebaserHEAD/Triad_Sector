...
shipyard-console-retrieve-impounded = That ship is impounded. Redeem it from the impound list.
...
shipyard-console-retrieve-abandoned = You gave that ship up. Contact an admin.
