...
shipyard-console-store-unregistered = That ship is not registered to any account and cannot be stored.
...
shipyard-console-retrieve-failed = That ship could not be retrieved. Try again shortly.
shipyard-console-retrieve-disabled = The drydock is not releasing ships right now.
...
shipyard-console-retrieve-abandoned = You abandoned that ship. Contact an admin.
...
shipyard-console-import-load-failed = The file would not load. Nothing has been spent; report it if it keeps happening.
shipyard-console-import-drydock-identity = That file describes a ship the drydock already holds. It cannot be imported.
...
shipyard-console-import-in-progress = This console is still importing the last one.
